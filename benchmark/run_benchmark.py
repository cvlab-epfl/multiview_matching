...
def generate_points(calibration, N=10, sigma_noise=10):
    ...
    for view in views:
        ...
        proj = cv2.projectPoints(points_3d, rvec, t, K, dist)[0].reshape(-1,2)
...
if __name__=='__main__':
    ...
    plt.ylabel('Time [s]')
    plt.title("Time required to find the correspondeces \n w.r.t number of objects and views. \n For real-time performance \n compute multiple frames in parallel.")
    plt.legend()
    plt.grid()
    plt.tight_layout()
